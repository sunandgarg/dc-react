...
const LEGACY_TEXT_MODELS = new Set(["gpt-5.6-sol", "gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-2.5-pro", "gemini-3.5-flash"]);
...
const defaults: State = { analysis_model: "gpt-5.6-luna", text_model: DEFAULT_TEXT_MODEL, image_model: "gpt-image-1", image_quality: "low", gemini_key_set: false, openai_key_set: false };

const TEXT_MODELS = [
  { value: "gpt-5.6-luna", label: "OpenAI GPT-5.6 Luna - default writer" },
  { value: "gpt-6-sol", label: "OpenAI GPT-6 Sol" },
  ...
  return <div className="mb-6 rounded-2xl border border-orange-200 bg-orange-50/40 p-5 dark:border-orange-900 dark:bg-orange-950/10">
    ...
    <div className="mt-4 grid gap-4 md:grid-cols-2">
      <div className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">Analysis model: GPT-5.6 Luna (fixed). The selected writing model powers Blog Studio and Auto Blog Agent drafts and rewrites.</p>
      </div>
