...
describe("premium IIT/IIM programme presentation", () => {
  it("uses the programme hero as full-bleed card media and keeps the institute logo", () => {
    render(
      <MemoryRouter>
    ...
    expect(screen.getByRole("img", { name: /Executive Programme.*IIM Kozhikode/i })).toHaveAttribute(
      "src",
